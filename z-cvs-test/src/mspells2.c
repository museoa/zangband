 ...
 */
static void monst_breath_monst(int m_idx, int y, int x, int typ,
	int dam_hp, int rad, bool breath)
{
...
bool monst_spell_monst(int m_idx)
{
	...
	for (i = 1; i < m_max; i++)
	{
		...
		if ((distance(m_ptr->fy, m_ptr->fx, y, x) > 1) || !rand_int(3))
			f6 &= ~(RF6_BLINK);
		...
		if (friendly && (p_ptr->chp > p_ptr->mhp / 4))
			f6 &= ~(RF6_TELE_AWAY);

		/* Remove some spells if necessary */
		if (!stupid_monsters && ((f4 & RF4_BOLT_MASK) ||
				(f5 & RF5_BOLT_MASK) || (f6 & RF6_BOLT_MASK)) &&
		...
		switch (thrown_spell)
		{
			...
			case 96 + 3:
			{
				...
				monst_breath_monst(m_idx, y, x, GF_ROCKET,
					((m_ptr->hp / 4) > 600 ? 600 : (m_ptr->hp / 4)), 2,
					FALSE);
			...
			case 96 + 4:
			{
				if (known)
				{
					if (see_either)
					{
						if (blind)
						{
							msg_format("%^s makes a strange noise.",
								m_name);
						}
						else
						{
			...
			case 96 + 8:
			{
				...
				monst_breath_monst(m_idx, y, x, GF_ACID,
					((m_ptr->hp / 3) > 1200 ? 1200 : (m_ptr->hp / 3)), 0,
					TRUE);
			...
			case 96 + 9:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes lightning at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 96 + 13:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes nether at %s.",
								m_name, t_name);
						}
					}
					else
				...
				monst_breath_monst(m_idx, y, x, GF_NETHER,
					((m_ptr->hp / 6) > 450 ? 450 : (m_ptr->hp / 6)), 0,
					TRUE);
			...
			case 96 + 14:
			{
				...
				monst_breath_monst(m_idx, y, x, GF_LITE,
					((m_ptr->hp / 4) > 350 ? 350 : (m_ptr->hp / 4)), 0,
					TRUE);
			...
			case 96 + 15:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes darkness at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 96 + 16:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes confusion at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 96 + 19:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format
								("%^s breathes disenchantment at %s.",
								m_name, t_name);
						}
					}
					else
				...
				monst_breath_monst(m_idx, y, x, GF_DISENCHANT,
					((m_ptr->hp / 4) > 400 ? 400 : (m_ptr->hp / 4)), 0,
					TRUE);
			...
			case 96 + 22:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes inertia at %s.",
								m_name, t_name);
						}
					}
					else
				...
				monst_breath_monst(m_idx, y, x, GF_INERTIA,
					((m_ptr->hp / 4) > 200 ? 200 : (m_ptr->hp / 4)), 0,
					TRUE);
			...
			case 96 + 23:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes gravity at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 96 + 24:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes shards at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 96 + 25:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s breathes plasma at %s.",
								m_name, t_name);
						}
					}
					else
				...
				monst_breath_monst(m_idx, y, x, GF_PLASMA,
					((m_ptr->hp / 4) > 150 ? 150 : (m_ptr->hp / 4)), 0,
					TRUE);
			...
			case 96 + 28:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format
								("%^s casts a ball of radiation at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 96 + 29:
			{
				...
				monst_breath_monst(m_idx, y, x, GF_NUKE,
					((m_ptr->hp / 2) > 600 ? 600 : (m_ptr->hp / 2)), 0,
					TRUE);
			...
			case 96 + 30:
			{
				if (known)
				{
					if (see_either)
					{
						...
						if (blind)
						{
							msg_format("%^s mumbles frighteningly.",
								m_name);
						}
						else
						{
			...
			case 96 + 31:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format
								("%^s breathes disintegration at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 128 + 0:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s casts an acid ball at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 128 + 2:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s casts a fire ball at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 128 + 3:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s casts a frost ball at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 128 + 5:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s casts a nether ball at %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 128 + 6:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format("%^s gestures fluidly at %s.",
								m_name, t_name);
			...
			case 128 + 8:
			{
				if (known)
				{
					if (see_either)
					{
						...
						{
							msg_format
								("%^s invokes a darkness storm upon %s.",
								m_name, t_name);
						}
					}
					else
			...
			case 128 + 9:
			{
				...
				{
					if (!tr_ptr->flags4 && !tr_ptr->flags5 &&
						!tr_ptr->flags6)
					{
						if (see_both)
						{
			...
			case 128 + 10:
			{
				if (see_m)
				{
					msg_format("%^s gazes intently at %s.", m_name,
						t_name);
				}
				...
				else
				{
					if (see_t)
					{
						msg_format("%^s is blasted by psionic energy.",
							t_name);
					}
			...
			case 128 + 12:
			{
				...
				if (tr_ptr->level > randint((rlev - 10) <
						1 ? 1 : (rlev - 10)) + 10)
				{
					if (see_both)
			...
			case 128 + 16:
			{
				...
				monst_bolt_monst(m_idx, y, x, GF_ACID, damroll(7,
						8) + (rlev / 3));
			...
			case 128 + 17:
			{
				if (known)
				{
					if (see_either)
					{
						msg_format("%^s casts a lightning bolt at %s.",
							m_name, t_name);
					}
					else
					{
				...
				monst_bolt_monst(m_idx, y, x, GF_ELEC, damroll(4,
						8) + (rlev / 3));
			...
			case 128 + 18:
			{
				...
				monst_bolt_monst(m_idx, y, x, GF_FIRE, damroll(9,
						8) + (rlev / 3));
			...
			case 128 + 19:
			{
				...
				monst_bolt_monst(m_idx, y, x, GF_COLD, damroll(6,
						8) + (rlev / 3));
			...
			case 128 + 21:
			{
				if (known)
				{
					if (see_either)
					{
						msg_format("%^s casts a nether bolt at %s.",
							m_name, t_name);
					}
					else
					{
				...
				monst_bolt_monst(m_idx, y, x, GF_NETHER, 30 + damroll(5,
						5) + (rlev * 3) / 2);
			...
			case 128 + 22:
			{
				...
				monst_bolt_monst(m_idx, y, x, GF_WATER, damroll(10,
						10) + rlev);
			...
			case 128 + 24:
			{
				if (known)
				{
					if (see_either)
					{
						msg_format("%^s casts a plasma bolt at %s.",
							m_name, t_name);
					}
					else
					{
				...
				monst_bolt_monst(m_idx, y, x, GF_PLASMA, 10 + damroll(8,
						7) + rlev);
			...
			case 128 + 25:
			{
				...
				monst_bolt_monst(m_idx, y, x, GF_ICE, damroll(6,
						6) + rlev);
			...
			case 128 + 26:
			{
				if (known)
				{
					if (see_either)
					{
						msg_format("%^s casts a magic missile at %s.",
							m_name, t_name);
					}
					else
					{
				...
				monst_bolt_monst(m_idx, y, x, GF_MISSILE, damroll(2,
						6) + (rlev / 3));
			...
			case 128 + 27:
			{
				...
				{
					if (see_t)
						msg_format("%^s refuses to be frightened.",
							t_name);
				}
				else if (tr_ptr->level > randint((rlev - 10) <
						1 ? 1 : (rlev - 10)) + 10)
				{
					if (see_t)
						msg_format("%^s refuses to be frightened.",
			...
			case 128 + 28:
			{
				...
				{
					if (see_t)
						msg_format("%^s is blinded!", t_name);
			...
			case 128 + 29:
			{
				...
				{
					if (see_t)
						msg_format("%^s disbelieves the feeble spell.",
							t_name);
				}
				else if (tr_ptr->level > randint((rlev - 10) <
						1 ? 1 : (rlev - 10)) + 10)
				...
				{
					if (see_t)
						msg_format("%^s seems confused.", t_name);
			...
			case 128 + 30:
			{
				...
				{
					if (see_t)
						msg_format("%^s starts moving slower.", t_name);
			...
			case 128 + 31:
			{
				...
				{
					if (see_t)
						msg_format("%^s is paralyzed!", t_name);
			...
			case 160 + 2:
			{
				if (known)
				{
					if (see_m)
					{
						msg_format("%^s concentrates on %s wounds.",
							m_name, m_poss);
					}
					else
					{
				...
				if (m_ptr->hp >= m_ptr->maxhp)
				{
					...
					if (known)
					{
						if (see_m)
						{
							msg_format("%^s looks completely healed!",
								m_name);
						}
						else
						{
				...
				if (m_ptr->monfear)
				{
					...
					/* Message */
					if (see_m)
						msg_format("%^s recovers %s courage.", m_name,
							m_poss);
				}
			...
			case 160 + 9:
			{
				...
				if (known)
				{
					if (see_either)
					{
						msg_format("%^s teleports %s away.", m_name,
							t_name);
					}
					else
					{
			...
			case 160 + 12:
			{
				...
				(void) project(m_idx, 3, y, x, 0, GF_DARK_WEAK,
...
flags1 & RF1_UNIQUE) ? "minions" : "kin"));
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_KIN,
						TRUE, friendly, pet);
				}
			...
			case 160 + 18:
			{
				...
				count +=
					summon_specific(m_idx, y, x, rlev, type, FALSE,
					friendly, pet);
			...
			case 160 + 19:
			{
				...
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons monsters!",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, type, TRUE,
						friendly, pet);
				}
			...
			case 160 + 20:
			{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_ANT,
						TRUE, friendly, pet);
				}
			...
			case 160 + 21:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons spiders.",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_SPIDER,
						TRUE, friendly, pet);
				}
			...
			case 160 + 22:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons hounds.",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_HOUND,
						TRUE, friendly, pet);
				}
			...
			case 160 + 23:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons hydras.",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_HYDRA,
						TRUE, friendly, pet);
				}
			...
			case 160 + 24:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons an angel!",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_ANGEL,
						TRUE, friendly, pet);
				}
			...
			case 160 + 25:
			{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_DEMON,
						TRUE, friendly, pet);
				}
			...
			case 160 + 26:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons undead.",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_UNDEAD,
						TRUE, friendly, pet);
				}
			...
			case 160 + 27:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format("%^s magically summons a dragon!",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_DRAGON,
						TRUE, friendly, pet);
				}
			...
			{
				int type =
					(friendly ? SUMMON_HI_UNDEAD_NO_UNIQUES :
					SUMMON_HI_UNDEAD);
			...
			{
				int type =
					(friendly ? SUMMON_HI_DRAGON_NO_UNIQUES :
					SUMMON_HI_DRAGON);
				...
				if (known)
				{
					if (see_either)
					{
						...
						msg_format
							("%^s magically summons ancient dragons!",
							m_name);
					}
					else
					{
			...
			case 160 + 30:
			{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev,
						SUMMON_AMBERITES, TRUE, FALSE, FALSE);
				}
			...
			case 160 + 31:
			{
				if (known)
				{
					if (see_either)
					{
						...
						msg_format
							("%^s magically summons special opponents!",
							m_name);
					}
					else
					{
				...
				{
					count +=
						summon_specific(m_idx, y, x, rlev, SUMMON_UNIQUE,
						TRUE, FALSE, FALSE);
				}
