...
may post your report or idea to the rec.games.roguelike.angband.
...
1.  All documets are in a fixed font, plain text format.
2.  Maximium line length of 70 characters.
3.  US spelling unless it directly conflicts with the game (for example
    the 'Spectre' race).
4.  No indenting of the first line of paragraphs.
5.  Left justification.
6.  Document titles are denoted by '=== Document Title ==='.
7.  Section headings are denoted by '=== Section Heading ==='.
8.  Sub-section headings are denoted by '--- Sub-section Heading ---'.
9.  Information on document authors and editors and revisions to be
    included at the end of each document.
10. Indenting increments by 5 spaces each time.
