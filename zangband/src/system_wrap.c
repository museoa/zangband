...
#define SWIG_init    initsystem

#define SWIG_name    "system"
...
static int _wrap_ANGBAND_DIR_SCRIPT_set(PyObject *val) {
    ...
    strcpy(ANGBAND_DIR_SCRIPT,tval);
    return 0;
}
...
extern "C" 
#endif
SWIGEXPORT(void,initsystem)() {
	 PyObject *m, *d;
	 SWIG_globals = SWIG_newvarlink();
	 m = Py_InitModule("system", systemMethods);
