			...
			if (!explode)
			{
				...
				switch (effect)
				{
					...
					case RBE_EXP_10:
					{
						...
						if ((OBJ_FLAG(p_ptr, 1, HOLD_LIFE)) && (randint0(100) < 95))
						{
					...
					case RBE_EXP_20:
					{
						...
						if ((OBJ_FLAG(p_ptr, 1, HOLD_LIFE)) && (randint0(100) < 90))
						{
							msgf("You keep hold of your life force!");
						}
						else
					...
					case RBE_EXP_80:
					{
						...
						if ((OBJ_FLAG(p_ptr, 1, HOLD_LIFE)) && (randint0(100) < 50))
						{
							msgf("You keep hold of your life force!");
						}
						else
