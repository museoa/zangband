...
#define SWIG_init    initutilc

#define SWIG_name    "utilc"
...
extern "C" {
#endif
static PyMethodDef utilcMethods[] = {
	 { NULL, NULL }
};
#ifdef __cplusplus
}
...
extern "C" 
#endif
SWIGEXPORT(void) initutilc() {
	 PyObject *m, *d;
	 SWIG_globals = SWIG_newvarlink();
	 m = Py_InitModule("utilc", utilcMethods);
