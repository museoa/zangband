...
extern void field_action_corpse_load(s16b *field_ptr, void *input);
...
extern void field_action_counter_init(s16b *field_ptr, void *input);
...
extern void field_action_isjewel_tester(s16b *field_ptr, void *input);
