...
extern void do_cmd_wield_aux(object_type *q_ptr, bool silently);
...
extern void identify_fully_aux(const object_type *o_ptr, const bool backstep);
...
extern bool player_item_equip(object_type *o_ptr);
extern void item_charges(object_type *o_ptr);
extern void item_describe(object_type *o_ptr);
extern void item_describe_roff(object_type *o_ptr, const bool backstep);
...
extern bool ident_by_item(const int k_idx);
extern bool ident_star_scroll(const int k_idx);
...
extern bool enchant_item(s32b cost, bool to_hit, bool to_dam, bool to_ac, bool weap, bool bow);
