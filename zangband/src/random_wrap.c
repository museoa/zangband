...
#define  SWIGTYPE_a_RAND_DEG__u32b swig_types[0] 
...
static PyObject *_wrap_Rand_state_get() {
    ...
    pyobj = SWIG_NewPointerObj((void *)Rand_state, SWIGTYPE_a_RAND_DEG__u32b);
    return pyobj;
}
...
static swig_type_info _swigt__a_RAND_DEG__u32b[] = {{"_a_RAND_DEG__u32b", 0, "u32b [RAND_DEG]"},{"_a_RAND_DEG__u32b"},{0}};

static swig_type_info *swig_types_initial[] = {
_swigt__a_RAND_DEG__u32b, 
0
};
