...
static PyMethodDef randomMethods[] = {
	 { "quick_rand_add", _wrap_quick_rand_add, 1 },
	 { "quick_rand", _wrap_quick_rand, 1 },
	 { "maxroll", _wrap_maxroll, 1 },
	 { "damroll", _wrap_damroll, 1 },
	 { "randnor", _wrap_randnor, 1 },
	 { "Rand_div", _wrap_Rand_div, 1 },
	 { "Rand_mod", _wrap_Rand_mod, 1 },
	 { "Rand_state_init", _wrap_Rand_state_init, 1 },
	 { "rand_range", _wrap_rand_range, 1 },
	 { "randint", _wrap_randint, 1 },
	 { "rand_int", _wrap_rand_int, 1 },
	 { NULL, NULL }
};
