...
static byte convert_old_names[180] =
{
	...
	ART_GRAYSWANDIR + 128,	/* 59 = SN_GRAYSWANDIR */
	...
	ART_CHAINSWORD + 128,	/* 132 = SN_CHAINSWORD */
	ART_GROO + 128,         /* 133 = SN_GROO */
...
static errr rd_savefile_old_aux(void)
{
	...
	/* Hack -- maximize mode */
	if (arg_crappy) maximize_mode = TRUE;
