...
bool activate_effect(object_type *o_ptr)
{
	...
	if (activate > 127)
	{
		switch (activate - 128)
		{
			case ART_GALADRIEL:
			{
				...
				o_ptr->timeout = rand_range(10, 20);
				break;
			}
			...
			case ART_THRAIN:
			{
				...
				o_ptr->timeout = rand_range(20, 40);
				break;
			}
			...
			case ART_CARLAMMAS:
			{
				...
				o_ptr->timeout = rand_range(225, 450);
				break;
			}
			...
			case ART_INGWE:
			{
				...
				o_ptr->timeout = rand_range(300, 600);
				break;
			}
			...
			case ART_BARAHIR:
			{
				...
				o_ptr->timeout = rand_range(100, 200);
				break;
			}
			...
			case ART_TULKAS:
			{
				...
				o_ptr->timeout = rand_range(150, 300);
				break;
			}
			...
			case ART_NENYA:
			{
				...
				o_ptr->timeout = rand_range(325, 650);
				break;
			}
			...
			case ART_VILYA:
			{
				...
				o_ptr->timeout = rand_range(425, 850);
				break;
			}
			...
			case ART_POWER:
			{
				...
				if (!get_aim_dir(&dir)) return FALSE;
				ring_of_power(dir);
				o_ptr->timeout = rand_range(450, 900);
				break;
			}
			...
			case ART_HOLHENNETH:
			{
				...
				detect_all();
				o_ptr->timeout = rand_range(55, 110);
				break;
			}
			...
			case ART_FINGOLFIN:
			{
				...
				o_ptr->timeout = rand_range(90, 180);
				break;
			}
			...
			case ART_DAWN:
			{
				...
				o_ptr->timeout = rand_range(500, 1000);
				break;
			}
	...
	switch (o_ptr->activate)
	{
		...
		case ACT_SUMMON_PHANTOM:
		{
			...
			o_ptr->timeout = rand_range(200, 400);
			break;
		}
		...
		case ACT_WRAITH:
		{
			set_wraith_form(p_ptr->wraith_form + rand_range(plev / 2, plev));
			o_ptr->timeout = 1000;
			break;
		}
