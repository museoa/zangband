...
/* Flag to show that the player arrived to the surface using a staircase */
bool use_stair_to_surface = FALSE;
...
wild_building_type wild_build[MAX_CITY_BUILD] =
{
	...
	{0, FT_STORE_WEAPON4, BT_STORE, 150, 200, 100, 60},
	{0, FT_STORE_WEAPON5, BT_STORE, 200, 200, 50, 70},
	...
	{0, FT_STORE_ARMOUR4, BT_STORE, 150, 200, 100, 60},
	{0, FT_STORE_ARMOUR5, BT_STORE, 200, 250, 50, 70},
	...
	{0, FT_STORE_SWORD4, BT_STORE, 200, 150, 100, 60},
	{0, FT_STORE_SWORD5, BT_STORE, 200, 200, 50, 70},
	...
	{0, FT_STORE_SHIELD4, BT_STORE, 200, 200, 50, 75},
	{0, FT_STORE_SHIELD5, BT_STORE, 200, 250, 50, 85},
	...
	{0, FT_STORE_AXE4, BT_STORE, 200, 150, 100, 60},
	{0, FT_STORE_AXE5, BT_STORE, 200, 150, 50, 70},
	{0, FT_STORE_AMMO0, BT_STORE, 150, 100, 100, 5},
	{0, FT_STORE_AMMO1, BT_STORE, 200, 200, 150, 10},
	{0, FT_STORE_AMMO2, BT_STORE, 250, 250, 150, 50},
	{0, FT_STORE_FLET0, BT_STORE, 100, 50, 100, 15},
	{0, FT_STORE_FLET1, BT_STORE, 100, 100, 100, 25},
	{0, FT_STORE_FLET2, BT_STORE, 150, 150, 150, 50},
	{0, FT_STORE_FLET3, BT_STORE, 150, 200, 150, 80},
	{0, FT_STORE_WARHALL0, BT_STORE, 50, 50, 50, 15},
	{0, FT_STORE_WARHALL1, BT_STORE, 50, 50, 50, 40},
	{0, FT_STORE_WARHALL2, BT_STORE, 100, 50, 100, 50},
	{0, FT_STORE_WARHALL3, BT_STORE, 100, 100, 100, 60},
	{0, FT_STORE_WARHALL4, BT_STORE, 150, 100, 200, 70},
	{0, FT_STORE_WARHALL5, BT_STORE, 150, 150, 250, 80},
	...
	{0, FT_STORE_HARMOUR1, BT_STORE, 150, 100, 100, 30},
	{0, FT_STORE_HARMOUR2, BT_STORE, 200, 150, 150, 50},
	{0, FT_STORE_HARMOUR3, BT_STORE, 200, 150, 150, 60},
	{0, FT_STORE_HARMOUR4, BT_STORE, 250, 200, 200, 70},
	{0, FT_STORE_HARMOUR5, BT_STORE, 250, 250, 200, 80},
	{0, FT_STORE_HAT0, BT_STORE, 200, 50, 150, 15},
	{0, FT_STORE_HAT1, BT_STORE, 200, 150, 150, 25},
	{0, FT_STORE_HAT2, BT_STORE, 200, 150, 200, 40},
	{0, FT_STORE_HAT3, BT_STORE, 250, 200, 200, 80},
	{0, FT_STORE_JEWEL0, BT_STORE, 150, 150, 150, 25},
	{0, FT_STORE_JEWEL1, BT_STORE, 150, 200, 150, 50},
	{0, FT_STORE_JEWEL2, BT_STORE, 200, 200, 200, 60},
	{0, FT_STORE_JEWEL3, BT_STORE, 200, 250, 200, 70},
	{0, FT_STORE_JEWEL4, BT_STORE, 200, 250, 250, 80},
	...
	{0, FT_STORE_POTION2, BT_STORE, 200, 200, 200, 60},
	{0, FT_STORE_POTION3, BT_STORE, 200, 200, 200, 70},
	{0, FT_STORE_POTION4, BT_STORE, 200, 200, 200, 80},
	{0, FT_STORE_SCROLL0, BT_STORE, 150, 150, 150, 15},
	{0, FT_STORE_SCROLL1, BT_STORE, 150, 150, 150, 50},
	{0, FT_STORE_SCROLL2, BT_STORE, 200, 200, 200, 60},
	{0, FT_STORE_SCROLL3, BT_STORE, 200, 200, 200, 70},
	{0, FT_STORE_SCROLL4, BT_STORE, 200, 200, 200, 80},
	...
	{0, FT_STORE_MAGIC3, BT_STORE, 150, 250, 250, 60},
	{0, FT_STORE_MAGIC4, BT_STORE, 200, 250, 250, 70},
	...
	{0, FT_STORE_BLACK1, BT_STORE, 200, 150, 50, 30},
	{0, FT_STORE_BLACK2, BT_STORE, 200, 200, 50, 80},
	{0, FT_STORE_ALCHEMY1, BT_STORE, 100, 150, 150, 25},
	{0, FT_STORE_ALCHEMY2, BT_STORE, 150, 200, 150, 50},
	...
	{0, FT_BUILD_MAGETOWER0, BT_BUILD, 100, 150, 100, 4},
...
static void move_char_to_stairs(int dx, int dy, place_type *pl_ptr)
{
	...
	p_ptr->py = pl_ptr->y * WILD_BLOCK_SIZE + dy;

	/* Only do this once when the stair was used */
	use_stair_to_surface = FALSE;
}
...
static void create_dungeons(int xx, int yy)
{
	...
	for (i = 0; i < NUM_DUNGEON; i++)
	{
		...
		/* A name */
		strcpy(place[best].name, format("%s dungeon",
			dungeon_type_name(place[best].dungeon->habitat)));
	}
