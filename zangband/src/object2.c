			...
			if (flags & OC_FORCE_GOOD)
			{
				...
				switch (randint1((o_ptr->tval == TV_POLEARM) ? 40 : 42))
				{
					...
					case 9: case 10:
					{
						...
						(void) random_resistance(o_ptr, randint1(12) + 4, 0);
						...
						if (randint0(100) < 20)
						{
							...
							(void) random_resistance(o_ptr, randint1(14) + 4, 0);
							ego = EGO_KILL_DRAGON;
						}
						break;
					}
			...
			switch (o_ptr->sval)
			{
				...
				case SV_RING_LORDLY:
				{
					...
					else
					{
						do
						{
							(void) random_resistance(o_ptr, randint1(20) + 18, 0);
						}
						while (randint1(4) == 1);
