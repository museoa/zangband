/*
** Lua binding: spell
** Generated automatically by tolua 4.0a - angband on Fri Nov  9 00:28:41 2001.
*/
...
/* function: bolt_pict */
static int toluaI_spell_bolt_pict00(lua_State* tolua_S)
{
 if (
     !tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
 ...
 else
 {
  ...
  int ny = ((int)  tolua_getnumber(tolua_S,3,0));
  int nx = ((int)  tolua_getnumber(tolua_S,4,0));
  int typ = ((int)  tolua_getnumber(tolua_S,5,0));
  byte a = ((byte)  tolua_getnumber(tolua_S,6,0));
  byte c = ((byte)  tolua_getnumber(tolua_S,7,0));
  {
   bolt_pict(y,x,ny,nx,typ,&a,&c);
 ...
 return 2;
tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'bolt_pict'.");
 return 0;
}

/* function: dist_to_line */
static int toluaI_spell_dist_to_line00(lua_State* tolua_S)
{
 if (
     !tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
 ...
 else
 {
  ...
  int x1 = ((int)  tolua_getnumber(tolua_S,4,0));
  int y2 = ((int)  tolua_getnumber(tolua_S,5,0));
  int x2 = ((int)  tolua_getnumber(tolua_S,6,0));
  {
   int toluaI_ret = (int)  dist_to_line(y,x,y1,x1,y2,x2);
   tolua_pushnumber(tolua_S,(long)toluaI_ret);
  }
 }
 return 1;
tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'dist_to_line'.");
 return 0;
}
...
static int toluaI_spell_raise_dead00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  {
   bool toluaI_ret = (bool)  raise_dead(y,x,pet);
   tolua_pushbool(tolua_S,(int)toluaI_ret);
  }
 }
 return 1;
...
static int toluaI_spell_destroy_area00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  {
   bool toluaI_ret = (bool)  destroy_area(y1,x1,r);
   tolua_pushbool(tolua_S,(int)toluaI_ret);
  }
 }
 return 1;
...
static int toluaI_spell_earthquake00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  int r = ((int)  tolua_getnumber(tolua_S,3,0));
  {
   bool toluaI_ret = (bool)  earthquake(cy,cx,r);
   tolua_pushbool(tolua_S,(int)toluaI_ret);
  }
 }
 return 1;
...
static int toluaI_spell_summon_cyber00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  {
   int toluaI_ret = (int)  summon_cyber(who,y,x);
   tolua_pushnumber(tolua_S,(long)toluaI_ret);
  }
 }
 return 1;
...
/* function: check_down_wild */
static int toluaI_spell_check_down_wild00(lua_State* tolua_S)
{
 if (
     !tolua_isnoobj(tolua_S,1)
 )
 ...
 {
  {
   bool toluaI_ret = (bool)  check_down_wild();
   tolua_pushbool(tolua_S,(int)toluaI_ret);
  }
 }
 return 1;
...
static int toluaI_spell_potion_smash_effect00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  int y = ((int)  tolua_getnumber(tolua_S,2,0));
  int x = ((int)  tolua_getnumber(tolua_S,3,0));
  int k_idx = ((int)  tolua_getnumber(tolua_S,4,0));
  {
   bool toluaI_ret = (bool)  potion_smash_effect(who,y,x,k_idx);
   tolua_pushbool(tolua_S,(int)toluaI_ret);
  }
 }
 return 1;
...
static int toluaI_spell_print_spells00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  {
   print_spells(&spells,num,y,x,realm);
...
static int toluaI_spell_polymorph_monster00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  int x = ((int)  tolua_getnumber(tolua_S,2,0));
  {
   bool toluaI_ret = (bool)  polymorph_monster(y,x);
   tolua_pushbool(tolua_S,(int)toluaI_ret);
  }
 }
 return 1;
...
int tolua_spell_open (lua_State* tolua_S)
{
 ...
 tolua_function(tolua_S,NULL,"bolt_pict",toluaI_spell_bolt_pict00);
 tolua_function(tolua_S,NULL,"dist_to_line",toluaI_spell_dist_to_line00);
 ...
 tolua_function(tolua_S,NULL,"check_down_wild",toluaI_spell_check_down_wild00);
...
void tolua_spell_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"bolt_pict");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"dist_to_line");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"check_down_wild");
